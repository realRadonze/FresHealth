...
struct HomeView: View {
    ...
    @State private var totalWater: Int = 8 // Assuming the total water goal is 8 cups
    @State private var totalCalorie: Double = 2000.0 // Assuming the total calorie goal is 2000
